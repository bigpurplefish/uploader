#!/usr/bin/env python3
"""Create 'Blue Mist Stepping Stones' with 1 variant.
...
DESCRIPTION_HTML = """<p>Create inviting garden paths and yard transitions with Blue Mist Stepping Stones. These irregular natural stone pieces feature soft blue-grey tones with a subtle misty character, laying down a path that blends naturally into your landscape.</p>

<h3>Key Features</h3>
<ul>
  <li><strong>Natural stone:</strong> Through-body color that resists fading and stands up to weather year after year.</li>
  <li><strong>Blue Mist tones:</strong> Cool blue-grey hues that complement water features, bluestone patios, and green plantings.</li>
...
<ul>
  ...
  <li><strong>Color:</strong> Blue Mist &mdash; soft blue-grey tones</li>
...
PRODUCT_INPUT = {
    "title": "Blue Mist Stepping Stones",
    "handle": "blue-mist-stepping-stones",
    "vendor": "Everlast",
    ...
    "variants": [
        {
            ...
            "inventoryItem": {
                "tracked": True, "sku": "40378", "cost": "14.10",
...
def main():
    ...
    log.info(f"Create Blue Mist Stepping Stones — mode: {mode}")
