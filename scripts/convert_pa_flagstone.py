#!/usr/bin/env python3
"""Convert single-variant 'Flagstone Irreg. 1"' (SKU 40368) into
...
OLD_PRODUCT_ID = "gid://shopify/Product/10409588818212"  # Flagstone Irreg. 1" (SKU 40368)
...
def main():
    ...
    log.info(f"Convert PA Flagstone — mode: {mode}")
    ...
    print(f"     {OLD_PRODUCT_ID}  (Flagstone Irreg. 1\", SKU 40368)")
