#!/usr/bin/env python3
"""Consolidate 'Blue Stone 12x24x1.5 Therma' (SKU 41506) and
'Flagstone Blue 24x36x1.5 Therm' (SKU 41507) into
'PA Bluestone Slate' with 3 variants.
...
OLD_PRODUCT_IDS = [
    "gid://shopify/Product/10409593864484",  # Blue Stone 12x24x1.5 Therma (SKU 41506)
    "gid://shopify/Product/10409593897252",  # Flagstone Blue 24x36x1.5 Therm (SKU 41507)
]

DESCRIPTION_HTML = """<p>Set a clean, modern surface with PA Bluestone Slate. These thermally finished pieces deliver a smooth, consistent texture with the classic blue-grey tones of Pennsylvania bluestone. Buy individual pieces in three sizes to build patios, walkways, landings, and pool surrounds with precise, tight-joint installations.</p>
    ...
    "variants": [
        {
            ...
            "inventoryItem": {
                "tracked": True, "sku": "41506", "cost": "19.70",
                "measurement": {"weight": {"value": 45.0, "unit": "POUNDS"}},
            },
...
def main():
    ...
    log.info(f"Convert PA Bluestone Slate — mode: {mode}")
